...
const App = ()=> {
  ...
  const [postParPage, setPostPerPage] = useState(10)
  ...
  return (
    ...
    <div className="w-full hljs-section flex gap-5 flex-wrap">
      {currentPost.map((item)=>(
        <div key={item.id} className="w-40 flex items-center justify-center flex-col h-40 bg-gray-200 rounded-md">
