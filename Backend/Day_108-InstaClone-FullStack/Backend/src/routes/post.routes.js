 ...
 * @description Create a post with the content and image (optional) provided in the request body. The post should be associated with the user that the request come from, req.body = { caption,image-file }
 * @access Private
 */
 ...
 * @description et all the posts created by the user that the request come from. also return the total number of posts created by the user
 * @access Private
 */
