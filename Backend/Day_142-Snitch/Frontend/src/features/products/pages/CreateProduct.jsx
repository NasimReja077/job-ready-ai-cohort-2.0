      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        ...
        <div className="pt-6 pb-2 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="mt-2 h-[2px] w-16 bg-linear-to-r from-[#e9c400] to-[#FFD700]" />
          </div>
        </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              {images.length < MAX_IMAGES && (
                <div
                  ...
                  className={` border-2 border-dashed rounded-sm px-6 py-12 lg:py-16 flex flex-col items-center gap-3 cursor-pointer transition-all duration-300${
                        isDragging
